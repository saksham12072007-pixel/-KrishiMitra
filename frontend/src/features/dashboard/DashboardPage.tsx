...
export function DashboardPage() {
  ...
  const trendData = (trends.data?.series ?? []).map(point => ({
    ...
    safe: point.no_action,
    moderate: point.monitor + point.irrigate_soon,
    urgent: point.irrigate_now,
  }));
